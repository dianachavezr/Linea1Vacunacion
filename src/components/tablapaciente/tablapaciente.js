import inicio from "../../assets/images/hogar.png"
...
const handleInputChange = (e) =>{
 ...
 <div className="cajapaciente">
    ...
    <a ><img src={inicio} alt="usuario" width="100px"/><Link to={`/dashboard/`}><p>Inicio</p></Link></a>
  </div>

    <div className="vacunacion">
    <a ><img src={vacunacion} alt="usuario" width="100px"/> <Link to={`/vacunacion/`}><p>Vacunación</p></Link></a>
   </div>
